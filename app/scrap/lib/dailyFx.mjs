...
export async function scrapDailyFxTable(url = 'https://www.dailyfx.com/sentiment-report', log = false) {
  try {
    ...
    if (response.status == 200) {
      ...
      const tableSelector =
        'body > div.dfx-slidableContent > div > main > article > section > div:nth-child(2) > div.col-12.col-lg-10.offset-lg-1.offset-xl-0.col-xl-8.dfx-border.dfx-border--r-xl-1 > div.dfx-articleBody > div > article > table';
